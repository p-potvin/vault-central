import{F as e,I as t,L as n,O as r,R as i,V as a,b as o,k as s,m as c,u as l,w as u}from"./globals.js";var d=a(i(),1),f=a(n(),1),p=a(e(),1),m=t(),h=()=>{let[e,t]=(0,d.useState)(null),[n,i]=(0,d.useState)([]),[a,f]=(0,d.useState)(!1),[h,g]=(0,d.useState)(!0),_=(0,d.useRef)([]);(0,d.useEffect)(()=>{(async()=>{let e=await u();t(e),i(Array(e.length).fill(``)),g(await r())})()},[]);let v=(t,r)=>{if(!/^\d*$/.test(r))return;let a=[...n];a[t]=r.slice(-1),i(a),f(!1),r&&t<n.length-1&&_.current[t+1]?.focus();let o=a.join(``);o.length===e.length&&b(o)},y=(e,t)=>{t.key===`Backspace`&&!n[e]&&e>0&&_.current[e-1]?.focus()},b=async t=>{t===e.pin?(await s({...e,lastUnlocked:Date.now()}),g(!1),p.default.runtime.sendMessage({action:`open_dashboard`}),setTimeout(()=>window.close(),200)):(f(!0),i(Array(e.length).fill(``)),_.current[0]?.focus())};return e?e.enabled?h?(0,m.jsxs)(`div`,{className:`w-[320px] p-6 bg-vault-bg text-vault-text flex flex-col items-center gap-6 select-none`,children:[(0,m.jsxs)(`div`,{className:`relative`,children:[(0,m.jsx)(c,{size:32,className:a?`text-red-500 animate-bounce`:`text-vault-accent`}),(0,m.jsx)(`div`,{className:`absolute -inset-1 blur-lg bg-vault-accent/20 rounded-full`})]}),(0,m.jsxs)(`div`,{className:`text-center space-y-1`,children:[(0,m.jsx)(`h2`,{className:`text-xs font-mono font-black uppercase tracking-[0.2em]`,children:`Authenticating`}),(0,m.jsxs)(`p`,{className:`text-[10px] text-vault-muted font-bold tracking-tighter opacity-60`,children:[`Enter `,e.length,`-digit sequence`]})]}),(0,m.jsx)(`div`,{className:`flex gap-3 justify-center`,children:n.map((e,t)=>(0,m.jsx)(`input`,{ref:e=>{_.current[t]=e},type:`password`,inputMode:`numeric`,pattern:`[0-9]*`,maxLength:1,value:e,onChange:e=>v(t,e.target.value),onKeyDown:e=>y(t,e),className:`
