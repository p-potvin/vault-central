...
const VaultCardItem = React.memo(({ fav, idx, viewSize, currentPage, itemsPerPage, handleEdit, handleDelete, setPlayingVideo, setVideoError, setIsRefreshing }) => {
