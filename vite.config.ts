    ...
    viteStaticCopy({
      targets: [
        ...
        },
        {
          ...
          // Trailing [0-9] so this covers both the solid and -nobg sized sets
          // while still excluding the masters (…-logo.png, …-nobg.png, *.svg).
          // Whichever set manifest.json points at, verify-manifest-icons.cjs
          // fails the build if a referenced file did not get copied.
